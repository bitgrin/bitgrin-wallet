...
use crate::api;
use crate::libwallet::{Error, ErrorKind, SlateLegacy};
...
#[derive(Clone)]
pub struct HTTPWalletCommAdapterLegacy {}

impl HTTPWalletCommAdapterLegacy {
	/// Create
	pub fn new() -> Box<dyn WalletCommAdapter> {
		Box::new(HTTPWalletCommAdapterLegacy {})
	}
}

impl WalletCommAdapter for HTTPWalletCommAdapterLegacy {

...
use bitgrin_core::core::amount_to_hr_string;
use bitgrin_core::core::committed::Committed;
use bitgrin_core::core::transaction::{kernel_features, kernel_sig_msg, Transaction, Weighting};
use bitgrin_core::core::verifier_cache::LruVerifierCache;
use bitgrin_core::libtx::{aggsig, build, secp_ser, tx_fee};
use rand::thread_rng;
use std::sync::Arc;
use uuid::Uuid;*/
...
pub struct ParticipantDataLegacy {
...
#[derive(Serialize, Deserialize, Debug, Clone)]
pub struct ParticipantMessageDataLegacy {
...
impl ParticipantMessageDataLegacy {
...
#[derive(Serialize, Deserialize, Debug, Clone)]
pub struct ParticipantMessagesLegacy {
	/// included messages
